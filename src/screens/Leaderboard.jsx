...
const columns = [
    ...
    {
        field: 'points', // Moved points to right of student
        headerName: 'Points',
        width: 100,
        type: 'number',
        headerAlign: 'left',
...
export default function Leaderboard() {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', width: '100%' }}>
            ...
            <Box sx={{ flexGrow: 1, width: '100%', '& .MuiDataGrid-root': { border: 'none', borderRadius: '12px' } }}>
                <DataGrid
                    rows={filteredRows}
                    columns={columns}
                    autoPageSize
                    ...
                    density="comfortable"
                    sx={{ height: '100%', width: '100%', '& .MuiDataGrid-virtualScroller': { overflowY: 'auto !important', } }}
                />
            </Box>
        </Box>
    );
